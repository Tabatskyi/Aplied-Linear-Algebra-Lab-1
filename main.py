...
def rotate_image(image, angle):
    ...
    rotated = ensure_2d_vectors(rotated)
    show_matrices([image, rotated], ["Original", f"Rotated by {angle}º (OpenCV)"])
...
#     print(scaled.shape)
#     print(scaled)
#     scaled = ensure_2d_vectors(scaled)
#     print(scaled)
#     show_matrices([image, scaled], ["Original", f"Scaled by {scale_x}, {scale_y} (OpenCV)"])
...
def reflect_image(image, axis):
    ...
    show_matrices([image, reflected], ["Original", f"Reflected across {axis} (OpenCV)"])
...
rotate_image(batman, 45)
# scale_image(batman, 2, 2)
reflect_image(batman, 'y')
angle_image(batman, 0.5, 'x')
